...
export default function HonorTemplate5({
  topStudents,
  selectedClass,
  honorSchoolName,
  honorPeriod,
    ...
    >
      <div
        className={`h-full flex flex-col ${
          showBorder
            ? "border-[10px] border-double border-emerald-600 rounded-2xl p-6"
            : "p-8"
        }`}
        style={{
      ...
      >
        <div className="text-center mb-4">
          ...
          <div className="flex items-center justify-center mt-2">
            ...
            <div className="h-px w-16 bg-emerald-600 mx-2"></div>
            <span className="text-emerald-600">◈</span>
            <div className="h-px w-16 bg-emerald-600 mx-2"></div>
            <span className="text-emerald-600">◈</span>
          </div>
        ...
        <div className="text-center mb-4">
          ...
          <div className="mt-2">
            <span
              className="inline-block bg-emerald-100 text-emerald-800 px-5 py-1 rounded-full text-sm font-semibold"
              style={{ fontFamily: "Khmer OS Muol Light" }}
            >
              {honorPeriod}
            </span>
        ...
        <div className="flex-1 space-y-3 mb-5">
          {topStudents.map((report, index) => (
            <div key={report.student.id}>
              <div className="flex items-center gap-4 bg-white rounded-2xl shadow-xl p-4 border-l-8 border-emerald-500">
                {showStudentPhotos ? (
        ...
        <div className="grid grid-cols-2 gap-12 text-center pt-4 border-t border-emerald-300">
          <div>
            <p className="text-xs mb-1">{reportDate}</p>
            <p className="text-xs mb-12">ត្រួតពិនិត្យ</p>
            <div className="inline-block border-t-2 border-emerald-400 pt-1 px-8">
              <p
