...
import { Camera, MapPin, Briefcase, GraduationCap, Star, CheckCircle2, Edit3, Globe, Sparkles } from "lucide-react";
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 pt-4 flex-wrap">
              <motion.div
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900/30 dark:to-orange-900/30 px-4 py-2 rounded-full shadow-md"
              >
              ...
              {user.currentStreak > 0 && (
                <motion.div
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 px-4 py-2 rounded-full shadow-md"
                >
