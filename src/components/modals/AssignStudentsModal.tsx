...
export default function AssignStudentsModal({
  ...
  const availableStudents = showAllStudents
    ...
    : students.filter((student) => !student.classId); // Only unassigned
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`បន្ថែមសិស្សចូលថ្នាក់ ${classData.name} • Add Students`}
      size="large"
    >
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">កំពុងផ្ទុកសិស្ស...</p>
            </div>
          </div>
        ) : (
          <>
                    ...
                    {currentStudents.length > 0 && (
                      <span className="text-sm">
                        ...
                        {currentStudents
                          .slice(0, 3)
                          .map(
                            (s) => s.khmerName || `${s.firstName} ${s.lastName}`
                          )
                          .join(", ")}
            ...
            <div className="flex items-center justify-between bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-3">
              <div>
                <p className="font-medium text-gray-900">
                  {showAllStudents
                    ...
                    : "បង្ហាញតែសិស្សគ្មានថ្នាក់ • Showing unassigned only"}
                </p>
                <p className="text-xs text-gray-600 mt-1">
                  {showAllStudents
                    ? "អាចផ្ទេរសិស្សពីថ្នាក់ផ្សេង • Can transfer from other classes"
                    : "បង្ហាញតែសិស្សដែលមិនទាន់មានថ្នាក់ • Only students without class"}
                </p>
              </div>
              <button
                type="button"
              ...
              >
                {showAllStudents ? "បង្ហាញតែគ្មានថ្នាក់" : "បង្ហាញទាំងអស់"}
              </button>
            </div>
                ...
                <div className="p-8 text-center text-gray-500">
                  ...
                  <p>
                    {searchTerm
                      ...
                      ? showAllStudents
                        ? "សិស្សទាំងអស់នៅក្នុងថ្នាក់នេះរួចហើយ • All students in this class"
                        : "សិស្សទាំងអស់មានថ្នាក់រួចហើយ • All students assigned"
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center text-white font-semibold">
                            {(student.khmerName || student.firstName)?.charAt(
                              0
                            )}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-orange-700 mt-1">
                      អ្នកកំពុងផ្ទេរសិស្ស {studentsToTransfer.length}{" "}
                      នាក់ពីថ្នាក់ផ្សេង។ សិស្សទាំងនេះនឹងត្រូវដកចេញពីថ្នាក់ចាស់
                      ហើយបន្ថែមចូលថ្នាក់ថ្មី។
                      <br />
                      <span className="text-xs">
                        You are transferring students from other classes. They
                        will be removed from their current class.
                      </span>
                    </p>
                  </div>
                </div>
