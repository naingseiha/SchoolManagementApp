              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 rounded-full">
                    ...
                    <span className="font-khmer-body text-xs font-bold text-blue-600">សកម្ម</span>
                  </div>
                </div>
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-green-50 rounded-full">
                    ...
                    <span className="font-khmer-body text-xs font-bold text-green-600">សកម្ម</span>
                  </div>
                </div>
                <p className="font-khmer-body text-gray-500 text-xs font-bold mb-2">
                  គ្រូបង្រៀន
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-purple-50 rounded-full">
                    ...
                    <span className="font-khmer-body text-xs font-bold text-purple-600">ថ្ងៃនេះ</span>
                  </div>
                </div>
                <p className="font-khmer-body text-gray-500 text-xs font-bold mb-2">
                  ថ្នាក់រៀន
              ...
              <div className="relative p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1.5 bg-orange-50 rounded-full">
                    ...
                    <span className="font-khmer-body text-xs font-bold text-orange-600">សកម្ម</span>
                  </div>
                </div>
                <p className="font-khmer-body text-gray-500 text-xs font-bold mb-2">
                  មុខវិជ្ជា
            ...
            <div className="bg-white rounded-3xl shadow-lg p-7 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-0.5">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="font-khmer-body text-xs text-gray-500 font-medium">វឌ្ឍនភាពនៃការចាត់ថ្នាក់</p>
                </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 mb-8">
            <div className="flex items-center gap-3 mb-7">
              ...
              <div>
                ...
                <p className="font-khmer-body text-sm text-gray-500 font-medium">រុករកទៅផ្នែកសំខាន់ៗ</p>
              </div>
            </div>
                ...
                <div className="bg-white rounded-3xl shadow-lg p-7">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="font-khmer-body text-xs text-gray-500 font-medium">៧ ថ្ងៃចុងក្រោយ</p>
                    </div>
                    <div className="p-2 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl">
                      <Activity className="w-5 h-5 text-white" />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="group flex items-center justify-between p-5 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl hover:shadow-md transition-all border-2 border-blue-100">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-khmer-body font-bold text-gray-900">ពិន្ទុថ្មី</p>
                          <p className="font-khmer-body text-xs text-gray-600 font-medium">ពិន្ទុបានកត់ត្រា</p>
                        </div>
                      </div>
                    ...
                    <div className="group flex items-center justify-between p-5 bg-gradient-to-br from-green-50 to-emerald-100/50 rounded-2xl hover:shadow-md transition-all border-2 border-green-100">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-khmer-body font-bold text-gray-900">វត្តមាន</p>
                          <p className="font-khmer-body text-xs text-gray-600 font-medium">វត្តមានថ្មីបានកត់ត្រា</p>
                        </div>
                      </div>
                ...
                <div className="bg-white rounded-3xl shadow-lg p-7">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="font-khmer-body text-xs text-gray-500 font-medium">ទិដ្ឋភាពចែកចាយ</p>
                    </div>
                ...
                <div className="bg-white rounded-3xl shadow-lg p-7">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="font-khmer-body text-xs text-gray-500 font-medium">ស្ថិតិ ៣០ ថ្ងៃចុងក្រោយ</p>
                    </div>
                        ...
                        <div className="relative">
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <h4 className="font-khmer-body font-black text-gray-900 text-lg">{cls.name}</h4>
                                <p className="font-khmer-body text-xs text-gray-600 font-medium">
                                  ថ្នាក់ទី {cls.grade} • {cls.studentCount} សិស្ស
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="pt-4 border-t-2 border-amber-200">
                            <p className="font-khmer-body text-xs text-gray-600 font-bold mb-2">ពិន្ទុមធ្យម</p>
          ...
          {statsError && (
            <div className="bg-gradient-to-br from-red-50 to-rose-50 border-2 border-red-200 rounded-3xl p-7 shadow-lg">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <p className="font-khmer-body font-black text-red-900 text-lg mb-1">បរាជ័យក្នុងការផ្ទុកស្ថិតិ</p>
                  <p className="font-khmer-body text-sm text-red-700 font-medium">{statsError}</p>
                </div>
              </div>
            </div>
          )}
