...
exports.deleteStudent = exports.updateStudent = exports.bulkCreateStudents = exports.createStudent = exports.getStudentById = exports.getAllStudents = exports.getStudentsLightweight = void 0;
const client_1 = require("@prisma/client");
const studentIdGenerator_1 = require("../utils/studentIdGenerator");
const dateParser_1 = require("../utils/dateParser"); // ✅ MUST HAVE THIS
...
exports.getStudentsLightweight = getStudentsLightweight;
/**
...
const createStudent = async (req, res) => {
    try {
        ...
        console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        const { firstName, lastName, khmerName, englishName, email, dateOfBirth, gender, placeOfBirth, currentAddress, phoneNumber, classId, fatherName, motherName, parentPhone, parentOccupation, remarks, } = req.body;
        ...
        const studentId = await (0, studentIdGenerator_1.generateStudentId)(classId);
        ...
        for (let i = 0; i < students.length; i++) {
            ...
            try {
                ...
                try {
                    ...
                    dateOfBirth = (0, dateParser_1.parseDate)(studentData.dateOfBirth);
...
const updateStudent = async (req, res) => {
    try {
        ...
        const { firstName, lastName, khmerName, englishName, gender, dateOfBirth, placeOfBirth, currentAddress, phoneNumber, email, classId, fatherName, motherName, parentPhone, parentOccupation, previousGrade, previousSchool, repeatingGrade, transferredFrom, grade9ExamSession, grade9ExamCenter, grade9ExamRoom, grade9ExamDesk, grade9PassStatus, grade12ExamSession, grade12ExamCenter, grade12ExamRoom, grade12ExamDesk, grade12PassStatus, grade12Track, remarks, photoUrl, } = req.body;
        ...
        if (khmerName !== undefined)
            updateData.khmerName = khmerName?.trim() || "";
        if (gender !== undefined)
